...
<main class="flex flex-1 flex-col px-3 sm:px-2">
  <div class="px-2 sm:px-8">
    <div class="bg-white rounded-2xl shadow-2xl">
      ...
      <!-- HEADER -->
      <header class="flex sm:flex-row sm:items-center sm:justify-between gap-2 p-3 px-2 border-b">
        <h2 class="text-2xl font-semibold text-gray-800 gap-4">Usuarios</h2>

        <button id="btn-pdf" class="bg-gray-200 p-2 sm:p-px rounded-lg
              hover:bg-red-200 shadow transition" title="PDF">
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF" class="fill-red-500">
